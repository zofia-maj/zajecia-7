#' ---
#' title: "Zaj_7.BoW_Przestrzen_wektorowa_Klastrowanie_kMeans_rozne_k"
#' author: "Autor: Zofia Maj"
#' date: "`r Sys.Date()`"
#' output:
#'   html_document:
#'     df_print: paged
...
#' # Wymagane pakiety
# Wymagane pakiety ----
#install.packages(c("tm","SnowballC","cluster", "wordcloud","dplyr","DT", "ggplot2", "ggthemes", "factoextra", "knitr))
